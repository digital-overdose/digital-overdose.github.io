...
export const speakers: TeamMember[] = [
  {
    ...
    imageUrl: '/assets/images/dovercon/2021/speakers/affinesecurity.png',
    links: [
      {
        label: 'Website',
        icon: 'fas fa-globe',
  ...
  },
  {
    ...
    imageUrl: '/assets/images/dovercon/2021/speakers/qhum7.jpg',
    links: [
      {
        label: 'Website',
        icon: 'fas fa-globe',
  ...
  },
  {
    ...
    imageUrl: '/assets/images/dovercon/2021/speakers/redwedgex.png',
    links: [
      {
        label: 'Twitter',
        icon: 'fab fa-fw fa-twitter-square',
  ...
  },
  {
    ...
    imageUrl: '/assets/images/dovercon/2021/speakers/f1nd3r.jpg',
    links: [
      {
        label: 'Twitter',
  ...
  },
  {
    ...
    imageUrl: '/assets/images/dovercon/2021/speakers/bosintblanc.jpg',
    links: [
      {
        label: 'Twitter',
        icon: 'fab fa-fw fa-twitter-square-square',
  ...
  },
  {
    ...
    imageUrl: '/assets/images/dovercon/2021/speakers/milleniumx.jpg',
    links: [
      {
        label: 'Medium',
        icon: 'fab fa-medium',
  ...
  },
  {
    ...
    imageUrl: '/assets/images/dovercon/2021/speakers/nas_bench.jpg',
    links: [
      {
        label: 'Twitter',
        icon: 'fab fa-fw fa-twitter-square',
  ...
  },
  {
    ...
    imageUrl: '/assets/images/dovercon/2021/speakers/nxi0us.jpg',
    links: [
      {
        label: 'Twitter',
        icon: 'fab fa-fw fa-twitter-square',
  ...
  },
  {
    ...
    imageUrl: '/assets/images/dovercon/2021/speakers/deeksha.jpg',
    links: [
      {
        label: 'Twitter',
        icon: 'fab fa-fw fa-twitter-square',
  ...
  },
  {
    ...
    imageUrl: '/assets/images/dovercon/2021/speakers/sovietlunox.jpg',
    links: [
      {
        label: 'LinkedIn',
        icon: 'fab fa-fw fa-linkedin',
  ...
  },
  {
    ...
    imageUrl: '/assets/images/dovercon/2021/speakers/trueno.jpg',
    links: [
      {
        label: 'LinkedIn',
        icon: 'fab fa-fw fa-linkedin',
  ...
  },
  {
    ...
    imageUrl: '/assets/images/dovercon/2021/speakers/heart.png',
    links: [
      {
        label: 'Twitter',
        icon: 'fab fa-fw fa-twitter-square',
